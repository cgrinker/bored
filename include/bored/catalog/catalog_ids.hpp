...
struct ConstraintId final {
    std::uint64_t value = 0U;
    [[nodiscard]] constexpr bool is_valid() const noexcept { return value != 0U; }
};

struct SequenceId final {
    std::uint64_t value = 0U;
    [[nodiscard]] constexpr bool is_valid() const noexcept { return value != 0U; }
};
...
constexpr bool operator==(ConstraintId lhs, ConstraintId rhs) noexcept { return lhs.value == rhs.value; }
constexpr bool operator!=(ConstraintId lhs, ConstraintId rhs) noexcept { return !(lhs == rhs); }
constexpr bool operator==(SequenceId lhs, SequenceId rhs) noexcept { return lhs.value == rhs.value; }
constexpr bool operator!=(SequenceId lhs, SequenceId rhs) noexcept { return !(lhs == rhs); }
