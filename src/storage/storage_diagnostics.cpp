...
void append_checkpoint_snapshot(std::string& out, const CheckpointTelemetrySnapshot& snapshot)
{
    ...
    append_field(out, "coordinator_begin_calls", snapshot.coordinator_begin_calls, first);
    append_field(out, "coordinator_begin_failures", snapshot.coordinator_begin_failures, first);
    append_field(out, "coordinator_prepare_calls", snapshot.coordinator_prepare_calls, first);
    append_field(out, "coordinator_prepare_failures", snapshot.coordinator_prepare_failures, first);
    append_field(out, "coordinator_commit_calls", snapshot.coordinator_commit_calls, first);
    append_field(out, "coordinator_commit_failures", snapshot.coordinator_commit_failures, first);
    append_field(out, "coordinator_abort_calls", snapshot.coordinator_abort_calls, first);
    append_field(out, "coordinator_dry_runs", snapshot.coordinator_dry_runs, first);
    append_field(out, "coordinator_total_begin_duration_ns", snapshot.coordinator_total_begin_duration_ns, first);
    append_field(out, "coordinator_last_begin_duration_ns", snapshot.coordinator_last_begin_duration_ns, first);
    append_field(out, "coordinator_total_prepare_duration_ns", snapshot.coordinator_total_prepare_duration_ns, first);
    append_field(out, "coordinator_last_prepare_duration_ns", snapshot.coordinator_last_prepare_duration_ns, first);
    append_field(out, "coordinator_total_commit_duration_ns", snapshot.coordinator_total_commit_duration_ns, first);
    append_field(out, "coordinator_last_commit_duration_ns", snapshot.coordinator_last_commit_duration_ns, first);
