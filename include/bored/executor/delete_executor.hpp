...
class DeleteExecutor final : public ExecutorNode {
public:
    struct DeleteStats final {
    ...
    public:
        ...
        virtual std::error_code delete_tuple(const TupleView& tuple,
                                             ExecutorContext& context,
                                             DeleteStats& out_stats) = 0;
    ...
    DeleteExecutor(ExecutorNodePtr child, Config config);
...
private:
    ...
    void apply_telemetry_success(const DeleteStats& stats) const;
